...
export default function OperationsManagerPerformance() {
  ...
  useEffect(() => {
    adminApi
      .get("/admin/operations-managers/performance")
  ...
  return (
    <div>
      <PageHeader
        title="Operations Manager Performance"
      ...
      <Card>
        ...
        <DataTable
          ...
          emptyMessage="Add operations managers to start tracking their delivery."
        />
      </Card>
    </div>
  );
