...
import { Eye, EyeOff, HardHat, FolderKanban, ClipboardCheck, UsersRound } from "lucide-react";
import api from "../api";

const HIGHLIGHTS = [
  { icon: FolderKanban, text: "Every project you lead, in one board" },
  { icon: UsersRound, text: "Your team's workload and performance" },
  { icon: ClipboardCheck, text: "Daily work review and sign-off" },
];
      ...
      <div className="relative hidden flex-col justify-between bg-[#0B0F1A] p-12 lg:flex">
        ...
        <div>
          ...
          <p className="mt-3 max-w-sm text-sm text-slate-400">
            Assign work, review what your team delivers and keep every deadline visible.
          </p>
