...
import { Eye, EyeOff, Briefcase, Gauge, CalendarClock, FolderOpen } from "lucide-react";
import api from "../api";

const HIGHLIGHTS = [
  { icon: Gauge, text: "Live progress on every project you have with us" },
  { icon: FolderOpen, text: "Contracts, drawings and invoices in one place" },
  { icon: CalendarClock, text: "Request meetings and share feedback directly" },
];
      ...
      <div className="relative hidden flex-col justify-between bg-[#0B0F1A] p-12 lg:flex">
        <div className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            ...
            <p className="text-[11px] uppercase tracking-widest text-slate-500">Client Portal</p>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="mt-3 max-w-sm text-sm text-slate-400">
            Track progress, read the documents and talk to the team — without waiting for an
            email.
          </p>
        ...
        <div className="w-full max-w-sm">
          <div className="mb-8 flex items-center gap-3 lg:hidden">
            ...
            <div className="leading-tight">
              ...
              <p className="text-[11px] uppercase tracking-widest text-slate-400">Client Portal</p>
            </div>
          </div>

          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Client sign in</h1>
          <p className="mt-1 text-sm text-slate-500">
            Use the email we have on file for your account
          </p>
          ...
          <p className="mt-8 text-center text-[11px] leading-relaxed text-slate-400">
            Portal access is set up by our team — there is no self sign-up. No login yet, or lost
            your password? Ask your project contact.
          </p>
        </div>
      </div>
    </div>
