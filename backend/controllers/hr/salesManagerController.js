...
/**
 * The password is the mobile number unless one is typed in — the same rule
 * every other account in this app follows, so there is one answer to "what is
 * their password" rather than one per screen.
 */
 ...
 * done is test it against the default this panel hands out, so HR can still
 * tell somebody their login rather than being forced to reset it.
 */
